...
.. code-block:: python
	...
	classifier = NodeClassifier(model, feature_vector_prop,
								feature_props, **kwargs)
...
.. code-block:: python
	...
	classifier = EdgePredictor(model, feature_vector_prop,
								feature_props, operator, directed)
